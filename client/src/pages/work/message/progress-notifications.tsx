...
export default function ProgressNotifications() {
  ...
  const { data: notifications = [], isLoading, error } = useQuery<Notification[]>({
    queryKey: ['/api/notifications?userId=1&type=progress'],
  });
        ...
        <div className="work-content">
          <div className="flex gap-6">
            ...
            <div className="flex-1">
              {/* 헤더 */}
              <div className="mb-6">
                <h1 className="work-title">진행현황 알림</h1>
              ...
              <div className="bg-white rounded-lg shadow-sm p-6">
                ...
                <div className="mb-4">
                  <span className="text-sm font-medium">관련 프로젝트</span>
                </div>
                <table className="w-full">
                  ...
                  <tbody>
                    {notifications.map((notif) => (
                      ...
                      >
                        <td className="py-3 text-sm">{notif.projectTitle} {notif.title}</td>
                        <td className="py-3 text-sm">{notif.company}</td>
