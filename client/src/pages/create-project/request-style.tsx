...
export default function Step1() {
  ...
  return (
    <Layout>
      {/* Original bg: default (no explicit bg class) */}
      <div className="py-8 sm:py-12 md:py-20 bg-white">
        <div className="page-content">
          ...
          {/* Additional Options - Only shown when public project is selected */}
          {selectedOption === 'public' && (
            ...
            >
              ...
              <div className="project-section project-section-horizontal">
                <span className="project-section-title"><span className="cotton-candy-pink">*</span> 파트너 선정방식</span>
                <RadioGroup value={progressStage} onValueChange={setProgressStage} className="flex gap-3 sm:gap-4">
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="lightweight" id="lightweight" data-testid="radio-lightweight" />
                    <Label htmlFor="lightweight" className="project-option-label">경쟁 PT</Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="solo" id="solo" data-testid="radio-solo" />
                    <Label htmlFor="solo" className="project-option-label">단독 PT</Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="fashion" id="fashion" data-testid="radio-fashion" />
                    <Label htmlFor="fashion" className="project-option-label">제안서 or 포트폴리오</Label>
                  </div>
                </RadioGroup>
              </div>
              ...
              {/* 진행 단계 선택 */}
              <div className="project-section project-section-horizontal">
                <span className="project-section-title"><span className="cotton-candy-pink">*</span> 진행 단계 선택</span>
                <div className="flex flex-wrap gap-3 sm:gap-4">
                  <div className="flex items-center space-x-2">
                    ...
                    />
                    <Label htmlFor="ot" className="project-option-label">OT (사전미팅)</Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <Checkbox 
                      id="pt1" 
                    ...
                    />
                    <Label htmlFor="pt1" className="project-option-label">PT (1차)</Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <Checkbox 
                      id="pt2" 
                    ...
                    />
                    <Label htmlFor="pt2" className="project-option-label">PT (2차)</Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <Checkbox 
                      id="video" 
                    ...
                    />
                    <Label htmlFor="video" className="project-option-label opacity-50">영상제작</Label>
                  </div>
                </div>
              </div>
            </motion.div>
          ...
          {/* Additional Options - Only shown when private (1:1) is selected */}
          {selectedOption === 'private' && (
            ...
            >
              ...
              <div className="project-section project-section-horizontal">
                <span className="project-section-title"><span className="cotton-candy-pink">*</span> 파트너 선정방식</span>
                <RadioGroup value={partnerSelection} onValueChange={setPartnerSelection} className="flex gap-3 sm:gap-4">
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="competitive" id="competitive" data-testid="radio-competitive" />
                    <Label htmlFor="competitive" className="project-option-label">경쟁 PT</Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="exclusive" id="exclusive" data-testid="radio-exclusive" />
                    <Label htmlFor="exclusive" className="project-option-label">단독 PT</Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="proposal" id="proposal" data-testid="radio-proposal" />
                    <Label htmlFor="proposal" className="project-option-label">제안서 or 포트폴리오</Label>
                  </div>
                </RadioGroup>
              </div>
              ...
              <div className="project-section project-section-horizontal">
                ...
                <div className="flex flex-wrap gap-3 sm:gap-4">
                  <div className="flex items-center space-x-2">
                    ...
                    />
                    <Label htmlFor="private-ot" className="project-option-label">OT (사전미팅)</Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <Checkbox 
                      id="private-pt1" 
                    ...
                    />
                    <Label htmlFor="private-pt1" className="project-option-label">PT (1차)</Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <Checkbox 
                      id="private-pt2" 
                    ...
                    />
                    <Label htmlFor="private-pt2" className="project-option-label">PT (2차)</Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <Checkbox 
                      id="private-video" 
                    ...
                    />
                    <Label htmlFor="private-video" className="project-option-label opacity-50">영상제작</Label>
                  </div>
                </div>
              </div>
          ...
          <div className="border border-gray-200 rounded-xl p-6 bg-white">
            ...
            <div className="flex justify-between items-start mb-4">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="px-3 py-1 bg-gray-100 text-gray-700 text-xs rounded-full">제작사 모집</span>
                <span className="px-3 py-1 bg-pink-50 text-pink-600 text-xs rounded-full">비로제작</span>
              </div>
            </div>
            ...
            <div className="flex flex-wrap gap-2 mb-4">
              <span className="px-3 py-1 bg-gray-100 text-gray-700 text-xs rounded-full">영상 기획</span>
              <span className="px-3 py-1 bg-gray-100 text-gray-700 text-xs rounded-full">영상 촬영</span>
              <span className="px-3 py-1 bg-gray-100 text-gray-700 text-xs rounded-full">편집 및 후반작업</span>
              <span className="px-3 py-1 bg-gray-100 text-gray-700 text-xs rounded-full">음악/BGM</span>
              <span className="px-3 py-1 bg-gray-100 text-gray-700 text-xs rounded-full">모델/배우 섭외</span>
              <span className="px-3 py-1 bg-gray-100 text-gray-700 text-xs rounded-full">매체 집행</span>
            </div>
            ...
            <div className="flex justify-between items-center pt-4 border-t border-gray-200">
              ...
              <div className="text-right">
                <div className="text-sm text-gray-500 mb-1">
                  제작비 <span className="text-xl font-bold text-pink-600">3~6억원</span>
                </div>
                <div className="text-xs text-gray-400">(총예산 10~20억원)</div>
                <div className="text-sm text-gray-700 mt-2">마감 <span className="font-bold">D-35</span></div>
              </div>
            </div>
      ...
      <Dialog open={showGuideDialog} onOpenChange={setShowGuideDialog}>
        <DialogContent className="sm:max-w-3xl max-h-[80vh] overflow-hidden [&>button]:z-20" data-testid="dialog-guide">
          ...
          <div className="space-y-6 overflow-y-auto px-6 pb-6" style={{ maxHeight: 'calc(80vh - 120px)' }}>
            {/* 회원가입 및 인증방법 안내 */}
                ...
                <table className="w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-gray-200 px-4 py-2">TVCF.co.kr 포트폴리오 100건 이상, 리뷰 평균 4.7점 이상</td>
                    </tr>
                    <tr>
                      <td className="border border-gray-200 px-4 py-2">Silver</td>
                      <td className="border border-gray-200 px-4 py-2">TVCF.co.kr 포트폴리오 50건 이상, 리뷰 평균 4.5점 이상</td>
                    </tr>
                    <tr>
                      <td className="border border-gray-200 px-4 py-2">Bronze</td>
                      <td className="border border-gray-200 px-4 py-2">TVCF.co.kr 포트폴리오 30건 이상, 리뷰 평균 4.0점 이상</td>
                    </tr>
                    <tr>
