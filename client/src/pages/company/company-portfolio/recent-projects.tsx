        ...
        <div className="work-content">
          <div className="flex gap-6">
            ...
            <div className="flex-1">
              <h1 className="work-title">Step10. 최근 참여 프로젝트</h1>
              ...
              <p className="text-sm text-gray-600 mb-6">TVCF에 등록된 3년 이내의 작품입니다. 노출을 원하는 작품을 선택해 주세요. (최대 20개)</p>

              <div className="bg-white rounded-lg shadow-sm p-6">
                <div className="flex items-center gap-3 mb-4">
                  <span className="text-sm">OnAir 일자</span>
                  <select className="px-3 py-1.5 border rounded text-sm" data-testid="select-recent-projects-onair-date">
                ...
                <div className="space-y-3">
                  {[1, 2, 3, 4, 5].map((item) => (
                    <div key={item} className="flex items-center gap-3 p-3 border rounded-lg" data-testid={`project-item-${item}`}>
                      <input type="checkbox" data-testid={`checkbox-project-${item}`} />
                      ...
                      <div className="w-24 h-16 bg-gray-200 rounded" data-testid={`project-thumbnail-${item}`}></div>
                    </div>
                  ))}
                </div>
                ...
                <div className="flex gap-3 mt-8 pt-6 border-t">
                  <Button variant="outline" className="btn-white" data-testid="button-recent-projects-prev" onClick={() => setLocation('/work/company-portfolio/staff')}>
                    이전
                  </Button>
                  <Button className="btn-pink" data-testid="button-recent-projects-next" onClick={() => setLocation('/work/company-portfolio/cotton-candy-activity')}>
                    다음
                  </Button>
                </div>
