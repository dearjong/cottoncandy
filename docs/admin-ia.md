...
| 항목 | v0.2 (이전) | v0.3 (현재) |
| --- | --- | --- |
| 공고 프로젝트 URL | `/admin/bidding` | `/admin/project_list/public` |
| 1:1 프로젝트 URL | `/admin/one-on-one` | `/admin/project_list/private` |
| 지원현황 소속 | 회원/기업 그룹 | 전체 프로젝트 그룹 |
| 운영 센터 구성 | 커뮤니케이션 / 공지&배너 통합 / 알림 설정 | 1:1 문의 / 신고 관리 / 알림 발송 / AI 채팅 / 공지사항 / 배너 관리 / 알림 설정 (7개로 세분화) |
| 신고 관리 소속 | 보안/감사 그룹 | 운영 센터 그룹 |
| 시스템 설정 추가 | — | 클릭 이벤트 로그 `/admin/event-log` |
| 메인 그룹 추가 | — | 통계 `/admin/dashboard` |
| 보안/감사 | 보안자료 + 신고 관리 | 보안자료만 |
